...
from kb.tests.fake_api import fakeQnAMakerAPI, fakeQnAMakerAPIgetDetailsBroken, fakeQnAMakerAPIsecondCallBroken
import json
...
def test_for_branch_completeness(mocker: MockFixture):
    ...
    runpy.run_module('kb.scripts.download-kb',
...
def test_download(mocker: MockFixture):
    ...
    fileOut().write.assert_called_with(json.dumps(jsonKB['qnaDocuments'], sort_keys=True, indent=4))
