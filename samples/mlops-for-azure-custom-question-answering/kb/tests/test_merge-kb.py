...
from kb.tests.fake_api import fakeQnAMakerAPImerge, returnSentBody, fakeQnAMakerAPImergeCallBroken,\
                              resetSentBody, fakeQnAMakerAPIcomplexMerge
import json
...
def test_for_branch_completeness(mocker: MockFixture):
    ...
    runpy.run_module('kb.scripts.merge-kb',
...
def test_merge_complex(mocker: MockFixture):
    ...
    assert returnSentBody(0) == \
           json.dumps({"qnAList": alMergeExpectedResult['qnaDocuments']})
